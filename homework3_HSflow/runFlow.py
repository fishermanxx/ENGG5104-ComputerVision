...
if __name__ == '__main__':
    # read 2 input frames
    img1 = cv2.imread('./data/other-data/Dimetrodon/frame10.png').astype('single')
    img2 = cv2.imread('./data/other-data/Dimetrodon/frame11.png').astype('single')
    # input ground truth optical flow
    flow_gt = ft.readFlowFile('./data/other-gt-flow/Dimetrodon/flow10.flo')
